...
def render_game_frame(view, game_range):
...
def run_game_loop(game_range, view, controller):
    ...
    while game_active:
        controller.exit_program()
        update_game_state(game_range, view, controller)
        render_game_frame(view, game_range)
        game_active = game_range.time_actions()
    return game_active


def run_endgame_screen(game_range, view, controller):
...
def main():
    ...
    run_endgame_screen(game_range, view, controller)
